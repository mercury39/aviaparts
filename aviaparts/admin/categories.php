...
if (isset($_GET['delete'])) {
    ...
    // Перевірка, чи є комплектуючі в цій категорії
    $checkParts = $conn->prepare("SELECT COUNT(*) as count FROM parts WHERE category_id = ?");
    $checkParts->bind_param('i', $id);
    $checkParts->execute();
    $result = $checkParts->get_result()->fetch_assoc();
    
    if ($result['count'] > 0) {
        $errorMessage = "Неможливо видалити категорію, оскільки до неї прив'язані комплектуючі!";
    } else {
        ...
        if ($stmt->execute()) {
            ...
            $errorMessage = "Помилка видалення категорії: " . $conn->error;
        }
    }
}
    ...
    <div class="row">
        <div class="col-md-12 mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <h1><i class="fas fa-comments"></i> Керування категоріями</h1>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <a href="../admin/parts.php?category=<?= $categoryToEdit['category_id'] ?>" class="btn btn-info">
