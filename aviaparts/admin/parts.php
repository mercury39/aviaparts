...
if (isset($_GET['delete']) && (int)$_GET['delete'] > 0) {
    ...
    try {
        // Спершу видаляємо зв'язані коментарі
        $stmt = $conn->prepare("DELETE FROM comments WHERE part_id = ?");
    ...
    <div class="row">
        <div class="col-md-12 mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <h1><i class="fas fa-comments"></i> Редагування комплектуючих</h1>
        ...
        <tr>
            ...
            <td class="text-right">
                ...
                <a href="parts.php?delete=<?= $p['part_id'] ?>" 
                   ...
                   onclick="return confirm('Ви впевнені, що хочете видалити цю запчастину разом з усіма пов\'язаними коментарями?')">
