...
$latestUsers = $conn->query("SELECT * FROM users ORDER BY created_at DESC LIMIT 5")->fetch_all(MYSQLI_ASSOC);
    ...
    <div class="row">
        <div class="col-md-12 mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <h1><i class="fas fa-cogs"></i> Адмін-панель AviaParts</h1>
        ...
        <div class="col-md-3">
            <div class="card bg-primary text-white">
                <div class="card-body">
                    ...
                    <a href="users.php" class="text-white">Керувати <i class="fas fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
        <div class="col-md-3">
                    ...
                    <ul class="nav nav-tabs card-header-tabs" id="dataTabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="users-tab" data-bs-toggle="tab" data-bs-target="#users" type="button" role="tab" aria-controls="users" aria-selected="false">
                                <i class="fas fa-users"></i> Останні користувачі
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                ...
                <div class="card-body p-0">
                    <div class="tab-content" id="dataTabsContent">
                        ...
                        <div class="tab-pane fade" id="users" role="tabpanel" aria-labelledby="users-tab">
                            <div class="d-flex justify-content-between align-items-center p-3 bg-light border-bottom">
                                <h5 class="mb-0">Останні користувачі</h5>
                                <a href="users.php" class="btn btn-sm btn-primary">Усі користувачі</a>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-hover mb-0">
                                    <thead>
                                    ...
                                    <tbody>
                                        <?php if (empty($latestUsers)): ?>
                                            <tr>
                                                <td colspan="3" class="text-center">Користувачі відсутні</td>
                                            </tr>
                                        <?php else: ?>
                                            <?php foreach ($latestUsers as $user): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge <?php echo $user['user_type'] == 'admin' ? 'bg-danger' : 'bg-secondary'; ?>">
